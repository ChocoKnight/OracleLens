create view teamBlueObjectives as 
select
t.id as id,
...
on g.id = o.game_id
where t.id = 233 and o.side = 'Blue'
group by t.id;

create view teamRedObjectives as 
select
t.id as id,
...
left join objectives as o
on g.id = o.game_id
where t.id = 233 and o.side = 'Red'
group by t.id;

create view teamPlayerStats as 
select 
t.id as teamId, 
p.id as playerId, 
...
drop view teamPlayerStats;
drop view teamBlueObjectives, teamRedObjectives